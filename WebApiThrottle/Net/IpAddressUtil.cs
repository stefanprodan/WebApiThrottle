...
namespace WebApiThrottle.Net
{
    public class IpAddressUtil
    {
        public static bool ContainsIp(List<string> ipRules, string clientIp)
        {
            ...
            if (ipRules == null || !ipRules.Any()) return false;
        ...
        public static IPAddress ParseIp(string ipAddress)
        {
            ...
            var portDelimiterPos = ipAddress.LastIndexOf(":", StringComparison.InvariantCultureIgnoreCase);
        ...
        public static bool IsPrivateIpAddress(string ipAddress)
        {
            ...
            var isIpv6 = octets.Length == 16;

            if (isIpv6)
            {
                var isUniqueLocalAddress = octets[0] == 253;
